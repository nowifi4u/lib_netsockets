...
namespace netsockets {
	...
	inline int parse_http_headers(socketfd_t fd, std::string& header)
    {
    ...
    inline unsigned long long http_get_field(const std::string& str_field, const std::string& str_header)
    {
    ...
    inline std::string http_get_body(const std::string& str_header)
    {
        std::string body;
    ...
    inline std::string http_get_method(const std::string& str_header)
    {
        std::string method;
        size_t pos = str_header.find(" ");
        if (pos == std::string::npos)
    ...
    inline std::string escape_space(const std::string& str)
    {
        std::string str_out;
        size_t pos = str.find(' ');
        if (pos == std::string::npos)
